...
import com.heima.model.articles.pojos.ApArticleConfig;
import com.heima.model.articles.pojos.ApArticleContent;
import com.heima.model.articles.vo.HotArticleVo;
...
public class ApArticleServiceImpl extends ServiceImpl<ApArticleMapper, ApArticle> implements ApArticleService {
    ...
    public ResponseResult load(Short loadtype, ArticleHomeDto dto) {
        ...
        //类型参数检验
        if(!loadtype.equals(ArticleConstant.LOADTYPE_LOAD_MORE)&&!loadtype.equals(ArticleConstant.LOADTYPE_LOAD_NEW)){
